...
import '../screens/Medicinal_PropertiesScreen.dart';
...
class PlantNameWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final plant = Provider.of<IdentificationProvider>(context).plants.isNotEmpty
        ? Provider.of<IdentificationProvider>(context).plants[0]
        : null;
